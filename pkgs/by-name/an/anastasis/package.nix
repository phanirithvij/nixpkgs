...
stdenv.mkDerivation (finalAttrs: {
  pname = "anastasis";
  #version = "0.6.6";
  version = "0.6.6-unstable-2025-10-08"; # 0.7.0

  src = fetchgit {
    url = "https://git.taler.net/anastasis.git";
    #tag = "v${finalAttrs.version}";
    #hash = "sha256-TVopOhVMGNWE2WD1swikzpcNP2DSbJhtQHBBGX/a7vA="; # 0.6.6
    rev = "925fc7d5e57752607d1bf76d367979c1f5e6b3fa";
    hash = "sha256-Vl0OE/6PGVEyQ9ZlkoD4bPspW5/Y0skrz+ng0P2xlRk="; # 0.7.0
  };
